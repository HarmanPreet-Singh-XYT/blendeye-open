...
export const SEED_ASSETS: CinemaAsset[] = [
  ...
  },
  {
    ...
    sizeBytes: 2400000,
    mimeType: "video/mp4",
    tags: ["video", "omni", "master", "cockpit", "take"],
    metadata: {
      preset: true,
      durationSec: 5,
  ...
  },
  {
    ...
    sizeBytes: 2500000,
    mimeType: "video/mp4",
    tags: ["video", "omni", "cockpit", "burn", "take"],
    metadata: {
      preset: true,
      durationSec: 5,
      model: "Gemini Omni Flash",
...
export const ASSET_CATEGORIES: Array<{
  ...
  { id: "video", label: "Video Footage & Takes", desc: "Generated video takes and live b-roll footage", iconName: "Video" },
